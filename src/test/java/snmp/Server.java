        ...
        SnmpAgent agent = new SnmpAgent(new AgentConfiguration(
                ...
                new Device(
                        ...
                        List.of(
                                ...
                                new Modifier<>(".1.3.6.1.2.1.2.2.1.10", new Counter32Modifier(0, Integer.MAX_VALUE, 0, 3840000)),
                                new Modifier<>(".1.3.6.1.2.1.2.2.1.11", new Counter32Modifier(0, Integer.MAX_VALUE, 0, 2000)),
                                new Modifier<>(".1.3.6.1.2.1.2.2.1.12", new Counter32Modifier(0, Integer.MAX_VALUE, 0, 2000)),
                                new Modifier<>(".1.3.6.1.2.1.2.2.1.13", new Counter32Modifier(0, Integer.MAX_VALUE, 0, 2000)),
                                new Modifier<>(".1.3.6.1.2.1.2.2.1.15", new Counter32Modifier(0, Integer.MAX_VALUE, 0, 2000)),
                                new Modifier<>(".1.3.6.1.2.1.2.2.1.16", new Counter32Modifier(0, Integer.MAX_VALUE, 0, 3840000)),
                                new Modifier<>(".1.3.6.1.2.1.2.2.1.17", new Counter32Modifier(0, Integer.MAX_VALUE, 0, 20000)),
                                new Modifier<>(".1.3.6.1.2.1.2.2.1.18", new Counter32Modifier(0, Integer.MAX_VALUE, 0, 20000)),
                                new Modifier<>(".1.3.6.1.2.1.2.2.1.19", new Counter32Modifier(0, Integer.MAX_VALUE, 0, 20000)),
                                new Modifier<>(".1.3.6.1.2.1.2.2.1.20", new Counter32Modifier(0, Integer.MAX_VALUE, 0, 20000)),
                                ...
                                new Modifier<>(".1.3.6.1.2.1.2.2.1.13", new Counter32Modifier(0, Integer.MAX_VALUE, 0, 20000)),
                                new Modifier<>(".1.3.6.1.2.1.2.2.1.14", new Counter32Modifier(0, Integer.MAX_VALUE, 0, 20000)),
                                new Modifier<>(".1.3.6.1.2.1.2.2.1.15", new Counter32Modifier(0, Integer.MAX_VALUE, 0, 20000)),
